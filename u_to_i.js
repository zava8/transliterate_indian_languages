...
const u_to_i = (ioz) => {
  ...
  while (indeks < inputLength) {
    ...
    if (0 === indeks) { curr_char = ioz.i[indeks]; } else { curr_char = nekst_char; }
    ...
    if (curr_lang_code > 0x11 && curr_lang_code < 0x1B) {
      ...
      else { ioz.o += u2idict.all_phoniks_list[curr_char_modulo]; }
      indeks++;
    ...
    //////////// other than sinhl bhαsα
      ...
      else { ioz.o += usinhl2idict.all_phoniks_list[curr_char_modulo]; }
      indeks++;
