...
export const Hh_to_phonetic_H = (ioz) => { ioz.i = ioz.i.replaceAll(
		/H/g,"h").replaceAll(
		/(\s)h/g,"$1H").replaceAll(
		/([^kgcꞇćjztdpbswटडपबसԃᴛ])h/ig,"$1H");
}
//////// ñṅ ꟈԃ[ɦꟈđꞇṅᴀ]ɦԃćńàᴀ
export const Nn_to_phonetic_N = (ioz) => { ioz.i = ioz.i.replaceAll(
		/N/g,"n").replaceAll(
...
// à
export const Ww_to_vv = (ioz) => { ioz.i = ioz.i.replaceAll(
		/W/g,"w").replaceAll(
...
// àα
export const Aa_to_phonetic_Aa = (ioz) => {
